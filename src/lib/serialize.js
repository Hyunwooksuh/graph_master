  ...
  for (var i = 0; i < json.length; i++) {
    ...
    switch (jsonObj['type']) {
      ...
      case 'Object':
        ...
        break;
      case 'ScopeReference':
        obj = EnhancedInterpreter.SCOPE_REFERENCE;
        break;
      case 'Function':
      ...
      case 'RegExp':
        ...
        break;
      case 'PseudoObject':
        obj = new EnhancedInterpreter.Object(null);
        break;
      case 'Scope':
        obj = new EnhancedInterpreter.Scope(undefined, undefined, undefined);
        break;
      case 'State':
        obj = new EnhancedInterpreter.State(undefined, undefined);
        break;
      case 'Node':
  ...
  for (var i = 0; i < objectList.length; i++) {
    ...
    switch (Object.getPrototypeOf(obj)) {
      ...
      case Object.prototype:
        if (obj === EnhancedInterpreter.SCOPE_REFERENCE) {
      ...
      case RegExp.prototype:
        ...
        continue;  // No need to index properties.
      case EnhancedInterpreter.Object.prototype:
        jsonObj['type'] = 'PseudoObject';
        break;
      case EnhancedInterpreter.Scope.prototype:
        jsonObj['type'] = 'Scope';
        break;
      case EnhancedInterpreter.State.prototype:
        jsonObj['type'] = 'State';
        break;
